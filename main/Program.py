...
def buscar_cnpjs_ativos_com_celular(data_inicial, data_final, limite=5, pagina=1):  # noqa: E501
    ...
    data = {
        "filters": {
            ...
            "mais_filtros": {
                "com_telefone": True,  # Garantir que a empresa tem um telefone
    ...
    if response.status_code == 200:
        ...
        # Exibe a resposta completa da API para verificar a estrutura dos dados
...
df_cnpjs_total = pd.DataFrame()  # DataFrame para armazenar todos os resultados
